...
Pod::Spec.new do |s|
  s.name             = 'wongyhelpers'
  s.version          = '0.1.0'
  s.summary          = 'A short description of wongyhelpers.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/samuelwong1992/wongyhelpers'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'samuelwong1992' => 'samuelwong1992@gmail.com' }
  s.source           = { :git => 'https://github.com/samuelwong1992/wongyhelpers.git', :tag => s.version.to_s }
